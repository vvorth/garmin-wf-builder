...
[`layouts:`](#styles-and-layouts) already switches widget content — see
below.
...
| `always` | **not implemented** — a friendly error naming why (see [Not yet implemented](#not-yet-implemented)) |
...
already introduces (see [Modes](#modes)), set by `onEnterSleep`/
