...
def resolve(r, element: IconElement, parent: Box, depth: int) -> Placed:
...
def draw_preview(renderer, placed: PlacedIcon) -> None:
...
def emit_draw(w: Writer, resolved, placed: PlacedIcon, value_guards, plan,
...
def layout_constants(prefix: str, placed: PlacedIcon) -> "layout_constants_mod.Constants":
