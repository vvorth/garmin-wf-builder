...
def resolve(r, element: Shape, parent: Box, depth: int) -> Placed:
...
def draw_preview(renderer, placed: PlacedShape) -> None:
    element = placed.element
...
def emit_draw(w: Writer, resolved, placed: PlacedShape, value_guards, plan,
...
def layout_constants(prefix: str, placed: PlacedShape) -> "layout_constants_mod.Constants":
    element = placed.element
