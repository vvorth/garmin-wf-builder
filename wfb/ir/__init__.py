...
from .model import (
    ...
    ROLE_ICON_COLOR, ROLE_OUTLINE_COLOR, ROLE_PART_VISIBLE, ROLE_PART_TEXT, ROLE_VISIBLE,
    ...
    ConfigDataSlot, Element, Group, Shape, HandPart, PolygonPart, RectanglePart, LinePart, CirclePart,
...
__all__ = [
    ...
    "MAX_OUTLINE_WIDTH",
    "ROLE_VALUE", "ROLE_MAX", "ROLE_MIN", "ROLE_FALLBACK", "ROLE_COLOR", "ROLE_TRACK_COLOR",
    "ROLE_ICON_COLOR", "ROLE_OUTLINE_COLOR", "ROLE_PART_VISIBLE", "ROLE_PART_TEXT",
    "ROLE_VISIBLE",
    "Position", "Size", "Expression", "FontSpec", "Curve", "Outline", "AodOverride", "ColorRole",
    "aod_color_choice", "aod_outline_choice", "disc_perimeter_offsets",
    "CONFIG_SYMBOL", "ConfigChoice", "ConfigAxis",
