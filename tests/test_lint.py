...
#: literal -- `wfb/ir/builder/reading.py`'s `expression` forwards `expr.ExprError.code` when
...
#: `bag.error` itself, `wfb/ir/builder/reading.py`'s `expression` does that once it catches
